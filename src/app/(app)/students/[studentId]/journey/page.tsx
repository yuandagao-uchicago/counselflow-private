      ...
      <div className="max-w-5xl mx-auto space-y-10 py-4">
        ...
        {total === 0 ? (
          <div className="rounded-3xl border border-dashed border-foreground/10 bg-card/50 p-12 text-center space-y-4">
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[oklch(0.34_0.13_25)] to-[oklch(0.34_0.13_25)] shadow-lg shadow-[oklch(0.34_0.13_25_/_30%)]">
