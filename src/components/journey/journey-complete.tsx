...
export function JourneyComplete({ completed, total, nextTitle }: JourneyCompleteProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-foreground/[0.08] bg-gradient-to-br from-[oklch(0.22_0.08_300)] via-[oklch(0.18_0.06_280)] to-[oklch(0.2_0.05_255)] p-8 md:p-10">
      {/* Glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-96 bg-[oklch(0.34_0.13_25_/_20%)] blur-3xl rounded-full pointer-events-none" />
      ...
      <div className="relative text-center space-y-4">
        ...
        {!allDone && nextTitle && (
          <div className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[oklch(0.34_0.13_25)] to-[oklch(0.34_0.13_25)] px-5 py-2.5 text-white shadow-lg shadow-[oklch(0.34_0.13_25_/_30%)]">
